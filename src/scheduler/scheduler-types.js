...
const CalendarData = Object.freeze((() => {
    function pack(calendarDataTemplate) {
        return {
            ...
            getCalendarDaysList: () => calendarDataTemplate.calendarDays,

            getNumberOfCalendarDays: () => calendarDataTemplate.calendarDays.length
        }
    }

    function create(monthIndex, year) {
        const calendarDays = (() => {
            const firstDayOffset = (new Date(year, monthIndex)).getDay();
